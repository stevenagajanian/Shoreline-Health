...
class ImmunizationsControllerTest < ActionController::TestCase
  ...
  test "should create immunization" do
    assert_difference('Immunization.count') do
      post :create, immunization: { b_validated: @immunization.b_validated, description: @immunization.description, name: @immunization.name, user_id: @immunization.user_id }
    end
  ...
  test "should update immunization" do
    patch :update, id: @immunization, immunization: { b_validated: @immunization.b_validated, description: @immunization.description, name: @immunization.name, user_id: @immunization.user_id }
    assert_redirected_to immunization_path(assigns(:immunization))
  end
